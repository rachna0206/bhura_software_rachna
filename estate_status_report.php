...
<?php if (in_array($user_id, $admin)) { ?>
  ...
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      <input type="button" class="btn btn-primary" name="btn_excel" value="Download Excel" onClick="javascript:estateGrid('<?php echo isset($_REQUEST['state_id']) ? $_REQUEST['state_id'] : "" ?>',
        ...
        <tbody class="table-border-bottom-0">
          ...
          while ($data = mysqli_fetch_array($result)) {
            ...
            <tr>
              ...
              <td>
                <a
                  href="javascript:editdata('<?php echo $data["id"] ?>','<?php echo $data["state_id"] ?>','<?php echo $data["city_id"] ?>','<?php echo $data["taluka"] ?>','<?php echo $data["area_id"] ?>','<?php echo $data["industrial_estate"] ?>','<?php echo $data["status"] ?>');"><i
              ...
              <div class="mb-3">
                ...
                <div class="form-check form-check-inline mt-3">
                  <input class="form-check-input" type="radio" name="verify_status" id="Verified" value="Verified"
                    onchange="getOtherOptions()" required>
                  <label class="form-check-label" for="inlineRadio1">Verified</label>
                </div>
                <div class="form-check form-check-inline mt-3">
                  <input class="form-check-input" type="radio" name="verify_status" id="Fake" value="Fake"
                    onchange="getOtherOptions()" required>
...
<script type="text/javascript">
  ...
  function estateGrid(state_id, city_id, taluka, area_id, industrial_estate, status, user_name, datetime) {
    const arr = [state_id, city_id, taluka, area_id, industrial_estate, status, user_name, datetime];
    window.open('estate_status_excel.php', '_blank');
