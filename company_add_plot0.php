          ...
          <form method="post" >
            ...
            <div id="select_estate_first_div" <?php echo (isset($selecttype_est) && $selecttype_est=="select_estate_first")?"":"hidden"?>>
              ...
              <div class="mb-3">
                ...
                <select name="rawdata_id_est" id="rawdata_id_est" onchange="get_companyStatus(this.value)" class="form-control" <?php echo (isset($selecttype_est) && $selecttype_est=="select_estate_first")?"required":"" ?>>
