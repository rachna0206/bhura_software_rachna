                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php if ($files_res['get_data_type'] == "retrieve" || $files_res['get_data_type'] == "calculate") { ?>
                                                                            <a
                                                                                href="javascript:file_set_values('<?php echo $files_res['page_name'] ?>','<?php echo $data['tatassign_inq_id'] ?>','<?php echo '0' ?>',0,'<?php echo $files_res['fid'] ?>','<?php echo $count ?>','<?php echo $files_res['get_data_type'] ?>','<?php echo $post_fields->Firm_Name ?>')">Fill
                                                                                Data</a>
                                                                        <?php } ?>
                                                                    </td>
