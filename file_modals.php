...
if (isset($_REQUEST['action'])) {
	...
	// process_gogtp_ir
	if ($_REQUEST['action'] == "agreement_format") {
		$html = "";
	...
	<input type="hidden" class="form-control" name="inq_id" id="inq_id" value="' . $inq_id . '"/>';
		...
		<div class="col mb-6">
			...
			<input type="text" class="form-control" name="scheme_name" id="scheme_name" value="' . ($edit ? $file_data->scheme_name : "") . '" required />
		</div>
		<div class="col mb-6">
			<label class="form-label" for="contact_person">Contact Person</label>
			<input type="text" class="form-control" name="contact_person" id="contact_person" value="' . ($edit ? $file_data->contact_person : "") . '" required />
		</div>
	</div>
	...
	<div class="row mb-3">
		<div class="col mb-6">
			<label class="form-label" for="receivable_amount">% of Receivable Amount</label>
	...
	<div class="row mb-3">
		<div class="col mb-6">
			<label class="form-label" for="at_time_of_sanction">At Time of Sanction</label>
			<input type="text" class="form-control" name="at_time_of_sanction" id="at_time_of_sanction" value="' . ($edit ? $file_data->at_time_of_sanction : "") . '" required />
		</div>
		<div class="col mb-6">
			<label class="form-label" for="at_time_of_visit">At Time of Visit</label>
			<input type="text" class="form-control" name="at_time_of_visit" id="at_time_of_visit" value="' . ($edit ? $file_data->at_time_of_visit : "") . '" required />
		</div>
	</div>
	...
	<div class="row mb-3">
		...
		$html .= '<div class="modal-footer">';
		if ($edit) {
			$html .= '<input type="submit" class="btn btn-primary" name="btn_update_agreement_format" id="btn_update_agreement_format" value="Update Changes">';
		} else {
			$html .= '<input type="submit" class="btn btn-primary" name="btn_agreement_format" id="btn_agreement_format" value="Save Changes">';
		}
		$html .= '<button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Close</button>
	</div>';
