          ...
          <li
            ...
            <?php
              ...
              if ($user_department=="admin" || $user_department=="assignor/verifier") {
                ...
                <li
                  class="menu-item <?php echo basename($_SERVER["PHP_SELF"]) == "assign_estate_plotting.php" ? "active" : "" ?>">
                ...
                <li
                  class="menu-item <?php echo basename($_SERVER["PHP_SELF"]) == "unassigned_estate_company.php" ? "active" : "" ?>">
                ...
                <li
                  class="menu-item <?php echo basename($_SERVER["PHP_SELF"]) == "estate_status_report.php" ? "active" : "" ?>">
                ...
                <li
                  class="menu-item <?php echo basename($_SERVER["PHP_SELF"]) == "visit_count_report.php" ? "active" : "" ?>">
                  <a href="visit_count_report.php" class="menu-link">
                    <div data-i18n="course">Visit Report</div>
                  </a>
                </li>
                <li class="menu-item <?php echo basename($_SERVER["PHP_SELF"]) == "user_report.php" ? "active" : "" ?>">
                  <a href="user_report.php" class="menu-link">
                    <div data-i18n="course">User Report</div>
                  </a>
                </li>
                ...
                <li
                  class="menu-item <?php echo basename($_SERVER["PHP_SELF"]) == "pr_file_format.php" ? "active" : "" ?>">
                ...
                <li
                  class="menu-item <?php echo basename($_SERVER["PHP_SELF"]) == "change_ind_estate_name.php" ? "active" : "" ?>">
                  <a href="change_ind_estate_name.php" class="menu-link">
                    <div data-i18n="course">Update Industrial Estate Name </div>
                  </a>
                </li>
